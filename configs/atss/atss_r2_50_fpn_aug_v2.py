...
# dict(
    #     type='OneOf',
    #     transforms=[
    #         dict(type='OpticalDistortion', p=1.0),
    #         dict(type='GridDistortion', p=1.0),
    #         dict(type='IAAPiecewiseAffine', p=1.0),
    #     ],
    #     p=0.2),
albu_train_transforms = [
    dict(
        type='OneOf',
        transforms=[
            dict(type='CLAHE', clip_limit=4, p=1.0),
            # dict(type='IAAEmboss',alpha=(0.2, 0.4), strength=(0.2, 0.4),p=1.0),
            dict(
    ...
    dict(type='ChannelShuffle', p=0.03),
    dict(
        type='OneOf',
        transforms=[
