...
log_level = 'INFO'
work_dir = '/media/dereyly/data_hdd/models/waymo/denc_reid_fc2'
load_from = '/media/dereyly/data_hdd/models/waymo/denc_reid_fc/epoch_4.pth'
resume_from = '/media/dereyly/data_hdd/models/waymo/denc_reid_fc/epoch_4.pth'
workflow = [('train', 1)]
